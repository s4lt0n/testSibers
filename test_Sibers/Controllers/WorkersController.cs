...
namespace test_Sibers.Controllers
{
    public class WorkersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,FirstName,SecondName,ThirdName,Email")] Worker worker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FirstName,SecondName,ThirdName,Email")] Worker worker)
        {
            if (ModelState.IsValid)
            {
